  ...
  <div class="section-body">
    <div class="row">
      <div class="col-12">
        ...
        @else
          @include('includes.empty-state', ['title'=>'Data '.$title, 'icon'=>'fa fa-money','link'=>route('metodes.create')])
        @endif
      </div>
...
@push('modals')
  @include('includes.modals.modal-import-excel', ['formAction'=>route('metodes.import-excel'),
  'downloadLink'=>route('metodes.import-excel-example')])
