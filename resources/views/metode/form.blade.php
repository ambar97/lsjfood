...
@section('content')
  <div class="section-header">
    ...
    <div class="section-header-breadcrumb">
      ...
      <div class="breadcrumb-item active">
        <a href="{{ route('metodes.index') }}">{{ __('Metode Pembayaran') }}</a>
      </div>
    ...
    <div class="row">
      <div class="col-12">
        <div class="card">
          ...
          <div class="card-body">
            <form action="{{ isset($d) ? route('metodes.update', [$d->id]) : route('metodes.store') }}"
              ...
              <div class="row">
                ...
                <div class="col-md-12">
                  ...
                  @include('includes.form.buttons.btn-reset',['link'=>route('metodes.index')])
                </div>
              </div>
            </form>
          </div>
